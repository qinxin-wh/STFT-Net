...
def main():
    ...
    # tracker_dir = '/omnisky2/wqx/Stark-main/pysot_toolkit/results/'
    root = os.path.join(tracker_dir,
                                 args.dataset,
                                 args.tracker_prefix)
    ...
    root = '/omnisky4/wqx/data/VOT2017TIR/'
            ...
            for attr, videos in dataset.attr.items():
                if attr == 'ALL':
                    draw_success_precision(success_ret,
                                       ...
                                       attr=attr,
                                       precision_ret=precision_ret)
    elif args.dataset in ['VOT2016', 'VOT2017', 'VOT2018', 'VOT2019', 'VOT2017TIR']:
