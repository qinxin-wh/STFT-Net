...
class NetWrapper:
    ...
    def load_network(self):
        net_path = 'Q:/Users/Administrator/Downloads/Stark-main/pysot_toolkit/checkpoints/train/stft/baseline/STARKST_ep0050.pth.tar'
        net = torch.load(net_path)['net']
        self.net = net.load_state_dict(net)
        if self.use_gpu:
            self.cuda()
        self.eval()
