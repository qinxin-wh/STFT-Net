...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def __init__(self, datasets, p_datasets, samples_per_epoch, max_gap,
                 num_search_frames, num_template_frames=1, processing1=no_processing, processing2=no_processing, frame_sample_mode='causal',
        ...
        self.processing1 = processing1
        self.processing2 = processing2
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                ...
                if dataset.name == 'TIR':
                    data = self.processing1(data)
                else:
                    data = self.processing2(data)
