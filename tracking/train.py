...
def main():
    args = parse_args()
    if args.mode == "single":
        train_cmd = "python /omnisky2/wqx/Stark-GFocal/lib/train/run_training.py --script %s --config %s --save_dir %s --use_lmdb %d " \
        ...
        train_cmd = "python -m torch.distributed.launch --nproc_per_node %d --master_port 24666 /omnisky3/wqx/Stark-GFocal-lsotb/lib/train/run_training.py " \
